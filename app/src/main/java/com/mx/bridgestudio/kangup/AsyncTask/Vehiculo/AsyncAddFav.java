...
public class AsyncAddFav extends AsyncTask<String,Integer,Boolean> {
    ...
    public AsyncAddFav(Context context, int id_vehiculo, int id_user) {
        super();
        mContext = context;
    ...
    protected Boolean doInBackground(String... params) {
        flag = Dveh.addFavoriteCar(id_vehiculo,id_user);
        return true;
    }
